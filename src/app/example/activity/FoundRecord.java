...
public class FoundRecord extends Activity implements IReflashListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (NetManager.isOpenNetwork(FoundRecord.this)) {
			no_net_cord.setVisibility(View.GONE);
			submitAsyncHttpClientGet(phone_number, true);

			dialog = new CustomProgressDialog(FoundRecord.this, "正在加载中",
					R.anim.frame);
			dialog.show();
	...
	private void init(final ArrayList<PersonData> apk_list) {
		if (adapter == null) {
			...
			adapter = new RecordAdapter(FoundRecord.this, apk_list);
	...
	public void onReflash() {
		...
		handler.postDelayed(new Runnable() {
			...
			public void run() {
				...
				if (RECORD == 1) {
					Toast.makeText(FoundRecord.this, "刷新成功", Toast.LENGTH_SHORT)
							.show();
					...
					Toast.makeText(FoundRecord.this, "刷新失败", Toast.LENGTH_SHORT)
							.show();
					autolistview.reflashComplete();
				}
	...
	public void onLoad() {
		...
		handler.postDelayed(new Runnable() {
			...
			public void run() {
				...
				Toast.makeText(FoundRecord.this, "已加载全部", Toast.LENGTH_SHORT)
						.show();
			}
		}, 2000);
	}
	...
	public void oncomment(int position) {
		...
		Intent intent = new Intent(FoundRecord.this,
				ListViewMessageDetails.class);
		intent.putExtras(bundle);
		FoundRecord.this.startActivity(intent);
	...
	public void onComplete(Platform plat, int action,
		...
		msg.arg2 = action;
		msg.obj = plat;
		UIHandler.sendMessage(msg, FoundRecord.this);
	}
	...
	public boolean handleMessage2(Message msg) {
		...
		Toast.makeText(FoundRecord.this, text, Toast.LENGTH_SHORT).show();
		return false;
	}
	...
	private void showShare(boolean silent, String platform,
		...
		oks.setSiteUrl(Urlt);
		oks.setImageUrl(FoundRecord.this.TEST_IMAGE_URL);
		oks.setFilePath(FoundRecord.this.TEST_IMAGE);
		...
		OnClickListener listener = new OnClickListener() {
			public void onClick(View v) {
				...
				Toast.makeText(FoundRecord.this, text, Toast.LENGTH_SHORT)
						.show();
			}
		};
	...
	private void ShowPickDialog(final int position) {
		...
		new MyAlertDialog(FoundRecord.this).builder().setTitle("提示！")
				.setMsg("你是真的真的不要我了么?")
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] responseBody) {
				...
				try {
					...
					handler.postDelayed(new Runnable() {
						...
						public void run() {
							apk_list = new ArrayList<PersonData>();
							AddLFRecordMessage.AddPersonDatas("findrecord",
									apk_list, true);
							if (apk_list.size() == 0) {
							...
							ShareSDK.initSDK(FoundRecord.this);
