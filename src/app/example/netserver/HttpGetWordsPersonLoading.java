...
public class HttpGetWordsPersonLoading {
	...
	public HttpGetWordsPersonLoading(String phone_number) {
			...
			public void handleMessage(Message msg) {
				...
				try {
					...
					List<Map<String, String>> list = MySQLiteMethodDetails
							.listWords_Db();
					if (5<=list.size()&&list.size()< 10) {
//						Log.i("HttpUtilPersonLoading", "所有数据：" + id + "---" + created
//								+ "---" + from_person + "---" + content + "---"
