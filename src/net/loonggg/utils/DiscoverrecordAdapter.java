...
public class DiscoverrecordAdapter extends BaseAdapter {
	...
	public DiscoverrecordAdapter(Context context,
			ArrayList<DiscoverMessageData> discover_message) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.looknum.setText(String.valueOf(looknumber));
	...
	class ViewHolder {
		...
		TextView title, time, textdetail, personnickname, titleshareno,
				titlecommentno, titlelikenno, looknum,personlocation;
