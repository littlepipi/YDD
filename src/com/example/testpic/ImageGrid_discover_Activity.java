...
public class ImageGrid_discover_Activity extends Activity {
	...
	Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case 0:
				Toast.makeText(ImageGrid_discover_Activity.this, "最多选择3张图片", 400).show();
				break;
...
//				if (Bimp.act_bool) {
//					Intent intent = new Intent(ImageGrid_discover_Activity.this,
//							PostDiscoverMessage.class);
//					startActivity(intent);
//					ImageGrid_discover_Activity.this.finish();
//					Bimp.act_bool = false;
//				}
	...
	private void initView() {
		...
		adapter = new ImageGridAdapter(ImageGrid_discover_Activity.this, dataList,
				mHandler);
