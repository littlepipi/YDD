...
public class ImageGrid_found_Activity extends Activity {
	...
	Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case 0:
				Toast.makeText(ImageGrid_found_Activity.this, "最多选择3张图片", 400).show();
				break;
...
//				if (Bimp.act_bool) {
//					Intent intent = new Intent(ImageGrid_found_Activity.this,
//							PostFoundMessage.class);
//					startActivity(intent);
//					ImageGrid_found_Activity.this.finish();
//					Bimp.act_bool = false;
//				}
	...
	private void initView() {
		...
		adapter = new ImageGridAdapter(ImageGrid_found_Activity.this, dataList,
				mHandler);
